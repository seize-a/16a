...
<head>
  ...
  <!-- Meta iOS pour plein écran -->
  <meta name="apple-mobile-web-app-capable" content="yes">
  <meta name="apple-mobile-web-app-status-bar-style" content="black-translucent">
  <meta name="apple-mobile-web-app-title" content="16A">
...
<body>
  ...
  <footer>
    <small>© 2025 16A - Tous droits réservés</small>
  </footer>
  ...
  <script>
    ...
    // Gestion de l'installation (Android + Chrome)
    let deferredPrompt;
    ...
    // Message d’installation iOS
    if (navigator.userAgent.match(/iphone|ipad|ipod/i)) {
      const iosPrompt = document.createElement('p');
